...
\begin{figure*}[t]
  ...
  \caption{Portrait editing trilemma concept. Left: structural trade-offs among identity preservation, stylization intensity, and inference speed. Right: conceptual illustration of the Trilemma axes; representative qualitative comparisons across paradigms are discussed in Section~\ref{sec:methodology}.}
...
\begin{tabular}{lcccp{1.8cm}ccl}
\toprule
\textbf{Method} & \textbf{Paradigm} & \textbf{Identity} & \textbf{Setup} & \textbf{Speed} & \textbf{T} & \textbf{Limitation} \\
\midrule
...
VToonify~\cite{yang2022vtoonify} & GAN & Multiscale feat.+StyleGAN & FF, StyleGAN ft. & $\bigstar$~RT & $\checkmark$ & Domain bound \\
\midrule
...
StyleMaster~\cite{ye2024stylemastersy} & Diff. & Motion adapt.+global proj. & FF, 10K pairs & $\blacktriangle$~0.6s & $\checkmark$ & Flicker \\
\midrule
